...
#   1. Create a github.com/rijulkalra2000/homebrew-coco repo
#   2. Copy this file to that repo as `Formula/coco.rb`
#   3. Tag a release on rijulkalra2000/coco with `v0.1.0`
#   4. Update sha256 below to match the release tarball
#   5. Users install via: `brew install rijulkalra2000/coco/coco`
#
...
class Coco < Formula
  ...
  homepage "https://github.com/rijulkalra2000/coco"
  url "https://github.com/rijulkalra2000/coco/archive/refs/tags/v0.1.0.tar.gz"
