...
```json
{
  "name": "coco",
  "displayName": "Coco",
  "description": "An entire team. In your terminal. Open-source AI workflow framework with skills, agents, commands, and multi-agent orchestration.",
  "version": "0.1.0",
  "author": "Coco Inc",
  "license": "MIT",
  ...
  "repository": {
    "type": "git",
    "url": "git+https://github.com/rijulkalra2000/coco.git"
  },
  "install": {
    "command": "bash",
...
**Tagline:** An entire team. In your terminal.
