...
# An entire team. In your terminal.
...
[![CI](https://img.shields.io/github/actions/workflow/status/rijulkalra2000/coco/ci.yml?branch=main&style=for-the-badge&label=CI)](https://github.com/rijulkalra2000/coco/actions)
[![GitHub stars](https://img.shields.io/github/stars/rijulkalra2000/coco?style=for-the-badge&logo=github)](https://github.com/rijulkalra2000/coco)
...
```bash
git clone https://github.com/rijulkalra2000/coco.git
cd coco
bash install.sh
```
...
<a href="https://www.star-history.com/#rijulkalra2000/coco&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=rijulkalra2000/coco&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=rijulkalra2000/coco&type=Date" />
    <img alt="Star history" src="https://api.star-history.com/svg?repos=rijulkalra2000/coco&type=Date" />
  </picture>
</a>
...
<sub>If Coco saves you time, <a href="https://github.com/rijulkalra2000/coco">star the repo</a>. It's the cheapest way to support the project.</sub>

<br><br>

**Coco** · MIT · © Coco Inc · <a href="https://github.com/rijulkalra2000/coco">GitHub</a> · <a href="https://github.com/rijulkalra2000/coco/issues">Issues</a> · <a href="CONTRIBUTING.md">Contribute</a>
