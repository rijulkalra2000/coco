...
<picture>
  ...
  <img src="assets/logo.svg" alt="Coco" width="160" height="160">
</picture>
...
<a href="https://www.star-history.com/#rkz91/coco&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=rkz91/coco&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=rkz91/coco&type=Date" />
    <img alt="Star history" src="https://api.star-history.com/svg?repos=rkz91/coco&type=Date" />
  </picture>
</a>
